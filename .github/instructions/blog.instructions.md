...
- Verify that each category value appears as a line in `/categories.txt` (for example, use `grep -Fx "<category>" categories.txt` for each category or open the file and confirm manually).
