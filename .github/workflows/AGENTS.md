...
| [opencode-review.yml](opencode-review.yml) | OpenCode PR review | pull_request_target (trusted authors), `workflow_call` |
...
- Triggers: pull_request_target (trusted authors), workflow_call.
